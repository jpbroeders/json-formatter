...
- **Repository:** `freelyit/json-formatter`
...
2. Public or private repository: `freelyit/json-formatter`
...
1. Go to repository: https://github.com/jpbroeders/json-formatter
...
docker run -p 3000:8080 freelyit/json-formatter:latest
```
...
- Verify repository name in workflow matches Docker Hub exactly: `freelyit/json-formatter`
...
- Dependencies only restored when `json-formatter.csproj` changes
